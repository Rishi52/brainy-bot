...
const ChatHeader = ({ subject, onSubjectChange, onSignOut }: ChatHeaderProps) => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-card/95 backdrop-blur-xl shadow-soft transition-smooth">
      <div className="flex items-center justify-between p-4 max-w-7xl mx-auto">
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <div className="relative flex items-center justify-center w-12 h-12 bg-gradient-to-br from-primary to-accent rounded-xl shadow-glow">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:block">
            <Select value={subject} onValueChange={onSubjectChange}>
              <SelectTrigger className="w-[200px] transition-smooth hover:bg-accent/5">
          ...
          <Button 
            ...
            size="icon" 
            onClick={onSignOut}
            className="transition-smooth hover:bg-destructive/10 hover:text-destructive hover:border-destructive/20"
          >
